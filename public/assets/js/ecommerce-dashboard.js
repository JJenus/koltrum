	...
	(function (factory) {
					...
					series: [
						{
							...
							showSymbol: !1,
							symbol: "circle",
							lineStyle: { width: 2, color: t("gray-200") },
							emphasis: { lineStyle: { color: t("gray-200") } },
						},
						{
							type: "line",
		...
		const projectionVsActualChartInit = () => {
			const {
				...
				i = o(10),
				n = [
					44485, 20428, 47302, 45180, 31034, 46358, 26581, 36628,
					38219, 43256,
				],
				l = [
					38911, 29452, 31894, 47876, 31302, 27731, 25490, 30355,
					27176, 30393,
				];
			if (a) {
				const o = e(a, "echarts"),
		...
		const leaftletPoints = [
			...
			{ lat: 46.716667, lng: -79.099998, name: "299" },
			{ lat: 45.016666, lng: -72.099998, name: "299" },
		];
						...
						series: [
							{
								...
								type: "line",
								data: [
									62, 90, 90, 90, 78, 84, 17, 17, 17, 17, 82,
									95,
								],
								showSymbol: !1,
								symbol: "circle",
							...
							},
							{
								...
								type: "line",
								data: [
									50, 50, 30, 62, 18, 70, 70, 22, 70, 70, 70,
									70,
								],
								showSymbol: !1,
								symbol: "circle",
								symbolSize: 10,
								emphasis: { lineStyle: { width: 1 } },
								lineStyle: { width: 1, color: t("info-200") },
								itemStyle: {
							...
							},
							{
								...
								type: "line",
								data: [
									40, 78, 60, 78, 60, 20, 60, 40, 60, 40, 20,
									78,
								],
								showSymbol: !1,
								symbol: "circle",
				...
				if (r) {
					...
					echartSetOption(i, a, () => ({
						...
						tooltip: {
							...
							transitionDuration: 0,
							formatter: (e) =>
								`<strong>${e.data.name}:</strong> ${e.percent}%`,
						},
						legend: { show: !1 },
						series: [
							{
		...
		const totalSalesChartInit = () => {
			const {
				...
				s = [
					100, 200, 300, 300, 300, 250, 200, 200, 200, 200, 200, 500,
					500, 500, 600, 700, 800, 900, 1e3, 1100, 850, 600, 600, 600,
					400, 200, 200, 300, 300, 300,
				],
				l = [
					200, 200, 100, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50,
					200, 400, 600, 600, 600, 800, 1e3, 700, 400, 450, 500, 600,
					700, 650, 600, 550,
				],
				c = (t) => {
					const o = window.dayjs(t[0].axisValue),
		...
		const chartJsInit = (t, e) => {
			...
			if (n) {
				...
				document.body.addEventListener(
					...
					({ detail: { control: o } }) => (
						"phoenixTheme" === o &&
							(t.destroy(), (t = new window.Chart(n, e()))),
						null
					)
				);
			}
				...
				chartJsInit(t, () => ({
					...
					options: {
						tooltips: {
							...
							titleColor: r("black"),
							position: "nearest",
							callbacks: { labelTextColor: () => r("black") },
						},
						rotation: -90,
						circumference: "180",
						cutout: "80%",
